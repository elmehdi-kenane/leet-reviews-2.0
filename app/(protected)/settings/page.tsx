...
const Settings = () => {
  //   const [originalDetails, setOriginalDetails] = useState<formDataType | null>(
  //     null,
  //   );
  //   const [updatedDetails, setUpdatedDetails] = useState<formDataType | null>(
  //     null,
  //   );
  //   useEffect(() => {}, []);
  ...
  //         <Profile setUpdatedDetails={setUpdatedDetails}></Profile>
...
//   setUpdatedDetails,
// }: {
//   setUpdatedDetails: (prev: formDataType) => void;
// }) => {
